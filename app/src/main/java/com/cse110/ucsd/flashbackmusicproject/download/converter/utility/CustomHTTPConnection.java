package com.cse110.ucsd.flashbackmusicproject.download.converter.utility;
...
public class CustomHTTPConnection{
    ...
    class HTTPResponse{
        ...
        HTTPResponse(String responseText){
            ...
            String headersText = "", bodyText = "";
            if (splitRes != null) {
                headersText = splitRes[0];
                bodyText = splitRes[1];
            }
    ...
    public String getResponseHeader(String key){
        ...
        for(Pair<String,String> pair : response.getHeaders()){
            if(pair.getFirst().toLowerCase().equals(key.toLowerCase())){
    ...
    public void setHeader(String key, String value){
        request.overwriteHeader(new Pair<String, String>(key,value));
    }
